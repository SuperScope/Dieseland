...
/*
void UVictoryBPFunctionLibrary::GetAllInputComponents(UObject* WorldContextObject, TArray<UInputComponent*>& Comps)
{
	...
	for(TObjectIterator<UInputComponent> Itr; Itr; ++Itr)
	{
		Comps.Add(*Itr);
	} 
}
UInputComponent* UVictoryBPFunctionLibrary::GetCharacterInputComponent(ACharacter* Character)
{
	if(!Character) return NULL; 
	
	return Character->InputComponent; 
}
*/
